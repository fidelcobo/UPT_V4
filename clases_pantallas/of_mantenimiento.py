...
class Ui_Maintenance_Dialog(object):
    def setupUi(self, Maintenance_Dialog):
        ...
        Maintenance_Dialog.setStyleSheet("QDialog{background-color:qconicalgradient(cx:0.8125, cy:0.761, angle:0, stop:0 rgba(191, 218, 15, 255), stop:0.16 rgba(136, 106, 22, 255), stop:0.225 rgba(166, 140, 41, 255), stop:0.285 rgba(204, 181, 74, 255), stop:0.345 rgba(235, 219, 102, 255), stop:0.415 rgba(245, 236, 112, 255), stop:0.52 rgba(209, 190, 76, 255), stop:0.57 rgba(187, 156, 51, 255), stop:0.635 rgba(168, 142, 42, 255), stop:0.695 rgba(202, 174, 68, 255), stop:0.75 rgba(218, 202, 86, 255), stop:0.815 rgba(208, 187, 73, 255), stop:0.88 rgba(187, 156, 51, 255), stop:0.935 rgba(137, 108, 26, 255), stop:1 rgba(172, 172, 172, 255))}")
        ...
        self.progreso.setGeometry(QtCore.QRect(30, 280, 351, 41))
        font = QtGui.QFont()
        font.setItalic(True)
...
"font-color:rgb(195, 0, 0)")
        ...
        self.version.setStyleSheet("color:rgb(0, 151, 227)")
